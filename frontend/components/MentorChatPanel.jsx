...
export default function MentorChatPanel({
  ...
  async function createNewSession(analysisId) {
    try {
  ...
  async function handleSendWithNewSession(message, analysisId) {
  ...
  async function sendMessageToSession(sessionId, content) {
