...
import { ExternalLink, Users, GitPullRequest, Eye, FolderGit2, EyeOff, Lock, Briefcase } from "lucide-react";
      ...
      <div className="relative h-44 bg-gray-800 overflow-hidden">
        {project.coverImage ? (
          ...
          <div className="w-full h-full flex items-center justify-center">
            <FolderGit2 className="h-12 w-12 text-gray-700" />
          </div>
        )}
        {project.category && (
        ...
        <div className="flex items-center justify-between pt-3 border-t border-gray-800">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link href={`/projects/${project.id}`}
              className="flex items-center gap-1 text-[10px] font-medium text-white bg-indigo-600 px-2.5 py-1 rounded-lg hover:bg-indigo-700 transition">
